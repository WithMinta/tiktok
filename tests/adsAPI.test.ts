...
describe("tiktok ads api", () => {
    describe("tiktok/uploadVideoToAdsAccount", () => {
        test("When trying to upload video with valid params response is 200 with valid data", async () => {
            // Arrange
